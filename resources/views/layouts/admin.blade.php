      ...
      <div class="container-xl">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" bis_skin_checked="1" data-bs-popper="static">
              <a class="dropdown-item" href="{{url('admin/users')}}" previewlistener="true">
                User
              </a>
              <a class="dropdown-item" href="{{url('admin/seller-info')}}" previewlistener="true">
                Seller Info
              </a>
            </div>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" bis_skin_checked="1" data-bs-popper="static">
              <a class="dropdown-item" href="{{url('admin/productcategories')}}" previewlistener="true">
                Categories
              </a>
              <a class="dropdown-item" href="{{url('admin/subcategory')}}" previewlistener="true">
                Sub Category
              </a>
              <a class="dropdown-item" href="{{url('admin/brands')}}" previewlistener="true">
                Brand
              </a>
              <a class="dropdown-item" href="{{url('admin/product')}}" previewlistener="true">
                Products
              </a>
            </div>
          </li>
