...
<head>
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{asset('user/assets/css/demo1.min.css')}}">
    ...
    <header class="header home">
        <div class="header-top bg-primary text-uppercase">
            <div class="container">
                ...
                <div class="header-right header-dropdowns ml-0 ml-sm-auto">
                    <p class="top-message mb-0 d-none d-sm-block">Welcome To Canvas Cart!</p>
            ...
            <div class="container">
                <div class="header-left col-lg-2 w-auto pl-0">
                    ...
                    <a href="{{ url('/') }}" class="logo">
                        <img src="{{asset('user/assets/images/logo.png')}}" alt="Canvas Cart Logo">
                    </a>
                </div>
                <!-- End .header-left -->
                            ...
                            <div class="dropdownmenu-wrapper custom-scrollbar">
                                ...
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="demo1-product.html" class="product-image">
                                                <img src="{{asset('user/assets/images/products/product-1.jpg')}}" alt="product" width="80" height="80">
                                            </a>
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="demo1-product.html" class="product-image">
                                                <img src="{{asset('user/assets/images/products/product-2.jpg')}}" alt="product" width="80" height="80">
                                            </a>
