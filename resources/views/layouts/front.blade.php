    ...
    <header class="header-style-5 color-style style-classic" id="sticky-header">
                    ...
                    <div class="main-menu">
                        ...
                        <div>
                            <form class="form_search" role="form">
                                <input id="query search-autocomplete" type="search" placeholder="Search any Device or Gadgets..." class="nav-search nav-search-field"
                                aria-expanded="true">
        ...
        <div class="bottom-part">
            <div class="container">
                <div class="row">
                    <div class="col-xl-3">
                        <div class="category-menu d-none d-xl-block">
                            <div id="toggle-sidebar" class="toggle-sidebar" style="padding-bottom: 20px !important;">
                                ...
                                <div>
                                    <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                        ...
                                        <li class="d-flex justify-content-between align-items-center">
                                            <a href="#">{{ $val->title }}</a>
                                            <span class="countss">{{ $val->products_count }}</span>
                                        </li>
                                        @endforeach
                        ...
                        <div class="main-nav-center">
                            <nav class="text-start">
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    <li>
                                        <a class="color-change-btn font-weight-bold active" href="{{url('/')}}">Home</a>
                                    </li>
                                    <li>
                                        <a class="color-change-btn font-weight-bold" href="{{url('shop')}}">shop</a>
                                    </li>
                                    <li>
                                        <a class="color-change-btn font-weight-bold" href="{{url('category')}}">Categories</a>
                                    </li>
                                    <li>
                                        <a class="color-change-btn font-weight-bold" href="#">Contact</a>
                                    </li>
                                    <li>
                                        <a class="color-change-btn font-weight-bold" href="#">blog</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div  class="col-xl-2 d-flex align-items-center">
                        <span>
                            <a href="{{ url('cart') }}">
                                <div>
                                    <i class="fa-solid fa-cart-shopping" style="font-size: 30px;color: #f85606;"></i>
                                </div>
                                <span class="cart_qty_cls" style="top: 0px;left: 40px;">2</span>
                            </a>
                        </span>
                        <span><i class="fa-solid fa-heart ms-4" style="font-size: 30px;color: #f85606;"></i></span>
                    </div>
                </div>
            </div>
        </div>
