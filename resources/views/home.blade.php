    ...
    <div class="container mb-2">
                    ...
                    <div class="product-default inner-quickview inner-icon">
                        <figure class="img-effect">
                            <a href="demo1-product.html">
                                <img src="{{url('storage/app/'.$val['featured_img'])}}" width="205" height="205" alt="product">
                        ...
                        <div class="product-details">
                            ...
                            <div class="category-wrap">
                                <div class="category-list">
                                    <a href="demo1-shop.html" class="product-category">{{$val['category']['title']}}</a>
                                </div>
                                <a href="wishlist.html" title="Add to Wishlist" class="btn-icon-wish">
                                    <i class="icon-heart"></i>
                                </a>
                            </div>
                            <h3 class="product-title"> <a href="demo1-product.html">{{$val['product_name']}}</a> </h3>
        ...
        <aside class="sidebar-home col-lg-3 order-lg-first mobile-sidebar">
            <div class="side-menu-wrapper text-uppercase mb-2 d-none d-lg-block">
                <h2 class="side-menu-title bg-gray ls-n-25 text-center">Top Categories</h2>

                <nav class="side-nav">
                    <ul class="menu menu-vertical sf-arrows">
                        @foreach($category as $val)
                        <li class=""><a href="demo1.html"><i class="icon-home"></i>{{ $val->title }}</a></li>
                        @endforeach
                    </ul>
                </nav>
            </div>
