              ...
              @endphp
                ...
                <div class="col-lg-6">
                    <div class="product-right">
                        ...
                        <div class="product-buttons" bis_skin_checked="1"><a href="javascript:void(0)" id="cartEffect" class="addTocartBtn btn btn-solid hover-solid btn-animation"><i class="fa fa-shopping-cart me-1" aria-hidden="true"></i> add to cart</a> <a href="#" class="btn btn-solid"><i class="fa fa-bookmark fz-16 me-2" aria-hidden="true"></i>wishlist</a></div>
