...
<section class="cart-section section-b-space prod_data">
	@if(!$wishlist->isEmpty())
	<div class="container">
		<div class="row">
            {{-- <div class="col-sm-12">
        ...
        <tbody>
         ...
         <td>
          ...
          <input type="hidden" value="{{$val->prod_id}}" class="prod_id" name="">
          <input type="hidden" value="{{$val->size}}" class="size" name="">
          <input type="hidden" value="{{$val->color}}" class="color" name="">

          <input type="text" name="quantity" class="form-control input-number quantity" value="1" fdprocessedid="rogv2">
...
<td>
    <button type="button" class="btn btn-solid px-3 py-2 addTocartBtn" style="font-size:25px ;">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.addTocartBtn').click(function(e){
            ...
            var color = $(this).closest('.prod_data').find('.color').val();
            var size = $(this).closest('.prod_data').find('.size').val();
            alert
            $.ajaxSetup({
                headers: {
